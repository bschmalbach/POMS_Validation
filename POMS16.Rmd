...
#a <- partialInvariance(measurementInvariance(model=model, data=df, estimator="mlr", group="ALTERSGRUPPEN", strict=T, fit.measures = c("chisq.scaled", "df", "cfi.robust", "rmsea.scaled")), type = "strict")
#a

#library(ezCutoffs)
#a <- ezCutoffs(model, data=df, n_rep = 100, estimator="mlr", fit_indices = c("chisq.scaled", "cfi.robust", "tli.robust", "rmsea.scaled", "srmr"))
#plot(a)
